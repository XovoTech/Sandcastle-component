...
if (wnd.location.hostname === "app.tenminutefunnels.com")
    whitelabelId = "10mf";
if (wnd.location.hostname === "app.salesfunnel.com")
    whitelabelId = "salesfunnel";
if (wnd.location.hostname === "tmf.drizzio.com")
    whitelabelId = "drizzio";
var adminId, adminIds, databaseId, simpleApi, websocketUrl, fileApi, cloudfrontDistribution;
if (state === "local") {
    adminId = "cjj7nq5ss02io01169z22tnwg";
    adminIds = ["cjyuon38x00fa0792wzw2v1lu"];
    databaseId = "cjp3yh54p0006015804un5vec";
    simpleApi = "http://".concat(wnd.location.hostname, ":60000/simple/v1");
    websocketUrl = "ws://".concat(wnd.location.hostname, ":60000/subscriptions/v1");
...
var settings = {
    ...
    app: {
        ...
        showAvatar: true,
        logoBlack: "https://medialibdata.s3.amazonaws.com/457/10MinuteFunnels_Logo_RGB.png",
        ...
        imgBlankState: "https://s3.amazonaws.com/sandcastleassets/images/dashboardBlankState.png",
        loadingImage: "https://s-media-cache-ak0.pinimg.com/originals/dd/67/4f/dd674f89d713bb2645a32925" +
            "10219998.gif",
        errorImage: "https://cdn.dribbble.com/users/1078347/screenshots/3066592/nointernetconnection_" +
            "emptystate_2.gif",
        ...
        cloudfrontDomain: state === "staging"
        ...
        allPages: [
            {
                id: 1,
                name: "Name #1",
                screenshot: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/e3067d59309437.5a1d8f1753" +
                    "ddc.png"
            },
            {
                id: 2,
                name: "Name #2",
                screenshot: "https://mir-s3-cdn-cf.behance.net/project_modules/1400/97102f58235685.59f47b5489" +
                    "43e.jpg"
            }
        ]
    },
...
exports.app = __assign(__assign(__assign({}, settings.app), lodash_1.default.get(settings.app, whitelabelId, settings.app)), { id: whitelabelId });
exports.default = __assign(__assign({}, settings), { app: exports.app });
