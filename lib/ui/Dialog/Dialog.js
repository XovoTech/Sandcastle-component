...
var DialogTitle = function (_a) {
    ...
    return (React.createElement("h5", { "data-testid": "Components-DialogTitle", style: __assign(__assign({}, style_1.default.dialogTitle), style) }, children));
};
...
var DialogBody = function (_a) {
    var _b = _a.style, style = _b === void 0 ? {} : _b, children = _a.children;
    return (React.createElement("div", { "data-testid": "Components-DialogBody", style: __assign(__assign({}, style_1.default.dialogBody), style) }, children));
};
...
var Dialog = function (_a) {
    var _b = _a.fullscreen, fullscreen = _b === void 0 ? false : _b, _c = _a.overlayStyle, overlayStyle = _c === void 0 ? {} : _c, _d = _a.style, style = _d === void 0 ? {} : _d, _e = _a.onClose, onClose = _e === void 0 ? function () { return null; } : _e, _f = _a.closeHref, closeHref = _f === void 0 ? "#" : _f, children = _a.children, _g = _a.centered, centered = _g === void 0 ? true : _g, _h = _a.overlay, overlay = _h === void 0 ? true : _h, _j = _a.closeAction, closeAction = _j === void 0 ? function () { return null; } : _j;
    var fullscreenStyle = fullscreen
        ? __assign(__assign({}, style_1.default.viewPort), style_1.default.fullscreen) : {};
    return (React.createElement("div", { "data-testid": "Components-Dialog", role: "group" },
        overlay && (React.createElement("div", { style: __assign(__assign(__assign({}, style_1.default.viewPort), style_1.default.overlay), overlayStyle) })),
        React.createElement(__1.Grid, { justify: "center", style: style_1.default.viewPort },
            React.createElement(__1.Cell, { align: "center", style: __assign(__assign(__assign({}, style_1.default.dialog), style), fullscreenStyle) },
